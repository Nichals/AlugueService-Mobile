...
{
    class ConsultaProdutoView : ContentPage
    {
        ConsultaProdutoViewModel consultaProdutoViewModel = new ConsultaProdutoViewModel();
        ...
        public ConsultaProdutoView()
        {
            ...
            {
                var pagina = new ResultadoConsultaProdutoView(consultaProdutoViewModel.ConsultarProduto((int)Convert.ToInt64(entryIdProduto.Text)));
